...
export const themes: Record<ThemeKey, ThemeConfig> = {
  ...
  carbon: {
    ...
    glassHover: 'hover:bg-white/12',
    text: 'text-white',
    textSecondary: 'text-emerald-100',
    textMuted: 'text-gray-400/70',
    cardBg: 'bg-white/8 backdrop-blur-xl border border-white/12',
    sidebarBg: 'bg-black/30 backdrop-blur-2xl border-r border-white/8',
    headerBg: 'bg-black/15 backdrop-blur-xl border-b border-white/8',
    inputBg: 'bg-white/8 border border-white/15 text-white placeholder:text-white/35',
  ...
  neon: {
    ...
    accentLight: 'bg-accent-500/20',
    glass: 'bg-white/8 backdrop-blur-xl',
    glassBorder: 'border border-violet-500/20',
    glassHover: 'hover:bg-white/12',
    text: 'text-white',
    textSecondary: 'text-violet-100',
    textMuted: 'text-violet-300/50',
    cardBg: 'bg-white/8 backdrop-blur-xl border border-violet-500/20',
    sidebarBg: 'bg-black/25 backdrop-blur-2xl border-r border-violet-500/15',
    headerBg: 'bg-black/15 backdrop-blur-xl border-b border-violet-500/15',
    inputBg: 'bg-white/8 border border-violet-500/20 text-white placeholder:text-white/35',
    badgeSuccess: 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30',
    badgeWarning: 'bg-amber-500/20 text-amber-300 border border-amber-500/30',
    badgeDanger: 'bg-red-500/20 text-red-300 border border-red-500/30',
    badgeInfo: 'bg-accent-500/20 text-accent-400 border border-accent-500/30',
  ...
  daylight: {
    ...
    glassBorder: 'border border-white/15',
    glassHover: 'hover:bg-white/15',
    text: 'text-white',
    textSecondary: 'text-blue-100',
    textMuted: 'text-slate-400/70',
    cardBg: 'bg-white/10 backdrop-blur-xl border border-white/15',
    ...
    inputBg: 'bg-white/10 border border-white/15 text-white placeholder:text-white/40',
    badgeSuccess: 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30',
    badgeWarning: 'bg-amber-500/20 text-amber-300 border border-amber-500/30',
    badgeDanger: 'bg-red-500/20 text-red-300 border border-red-500/30',
    badgeInfo: 'bg-accent-500/20 text-accent-400 border border-accent-500/30',
